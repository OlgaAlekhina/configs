...
from .models import Config, meta_default_value, get_next_internal_id


class ConfigsBulkSerializer(serializers.ListSerializer):
    ...
    def create(self, validated_data):
        ...
        for item in validated_data:
            ...
            item.pop("meta")
            object_data.append(Config(meta=meta_data, **item))

        return Config.objects.bulk_create(object_data)
...
class ConfigSerializer(serializers.ModelSerializer):
    id = serializers.UUIDField(validators=[UniqueValidator(queryset=Config.objects.all())],
                               allow_null=True)
    ...
    def create(self, validated_data):
        ...
        instance = Config.objects.create(meta=meta_data, **validated_data)
    ...
    class Meta:
        ...
        list_serializer_class = ConfigsBulkSerializer
